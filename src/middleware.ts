...
const retiredPublicRouteRedirects: Array<{
  ...
  { pattern: /^\/combat(?:\/.*)?$/, target: '/guides/army-formations' },
  { pattern: /^\/map(?:\/.*)?$/, target: '/guides/lairs-world-map' },
  ...
  {
    pattern: /^\/machinefall-beginner-guide(?:\/.*)?$/,
    target: '/guides/beginner-guide',
  },
  {
    pattern: /^\/machinefall-lairs?(?:\/.*)?$/,
    target: '/guides/lairs-world-map',
  },
  {
    pattern: /^\/machinefall-download(?:\/.*)?$/,
    target: '/download',
  },
];
...
export default async function middleware(req: NextRequest) {
  ...
  const productionHosts = new Set(['machinefall.wiki', 'www.machinefall.wiki']);
  const canonicalHost = 'www.machinefall.wiki';
