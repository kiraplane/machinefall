...
export function Footer({ className }: React.HTMLAttributes<HTMLElement>) {
  ...
  return (
    <footer
      className={cn(
        'border-[#2a4434] border-t bg-[#080d0b] text-[#f4f1df]',
        className
      )}
    >
      ...
      <div className="border-[#2a4434] border-t py-8">
        <Container className="px-4 flex items-center justify-between gap-x-4">
          ...
          <span className="text-muted-foreground text-sm">
            Independent Machinefall guide site. Not affiliated with Jan Zizka,
            Valve, Steam, Discord or YouTube.
          </span>
        </Container>
      </div>
    </footer>
