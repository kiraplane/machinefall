...
export const CANONICAL_BASE_URL = 'https://www.machinefall.wiki';
...
function getMachinefallBaseUrl(url?: string) {
  ...
  try {
    ...
    if (
      parsedUrl.hostname === 'machinefall.wiki' ||
      parsedUrl.hostname === 'www.machinefall.wiki'
    ) {
...
export function getBaseUrl(): string {
  ...
  const machinefallBaseUrl = getMachinefallBaseUrl(configuredBaseUrl);
  if (machinefallBaseUrl) {
    return machinefallBaseUrl;
  }
