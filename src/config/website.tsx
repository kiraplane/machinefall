...
export const websiteConfig: WebsiteConfig = {
  ...
  metadata: {
    ...
    social: {
      ...
      twitter: '',
      blueSky: '',
      discord: 'https://discord.gg/DQAd2Kq7sa',
      mastodon: '',
      linkedin: '',
      youtube: 'https://www.youtube.com/@facteroids',
    },
  },
  features: {
  ...
  mail: {
    provider: 'resend',
    fromEmail: 'Machinefall Wiki <hello@machinefall.wiki>',
